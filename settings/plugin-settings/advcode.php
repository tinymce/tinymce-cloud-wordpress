...
<div style="margin-bottom: 20px; border: 2px solid #ccc; padding: 0 15px; width: 95%;">
    <h2 class="title">TinyMCE Advanced Code Editor Settings</h2>
    <p>For more details on the Advanced Code Editor please see the
        <strong><a href="https://www.tinymce.com/docs/plugins/advcode/" target="_blank">product documentation</a></strong>
    </p>
    <table class="form-table">
        <tbody>
        <tr>
            <th scope="row">Enable Advanced Code Editor:</th>
            <td colspan="3">
