...
?>
<div class="wrap">
    <h1 style="padding-bottom:20px;">TinyMCE Cloud</h1>
</div>
<form method="post" action="options.php">
    ...
    ?>
    <h2 style="padding-top: 25px;">Please activate each of the TinyMCE Cloud extensions you have purchased by clicking on the checkbox next to "Enable"</h2>
    <?php
